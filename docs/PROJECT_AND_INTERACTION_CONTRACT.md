...
Use the wheel to choose intent, handles to manipulate geometry, and nearby feet/inches fields for exact values. Large plant/material collections belong in a temporary panel rather than nested rings of tiny choices. Specific sector layout, flick thresholds and handedness behavior are proposals to test, not fixed values invented by this document.
